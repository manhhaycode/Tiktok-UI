            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('search-bar__container')}>
                    <form className={cx('search-bar__form')}>
                        ...
                        <button className={cx('search-bar__search--icon')} typeof="submit">
                            <svg
                                width="24"
                                data-e2e=""
                                height="24"
                ...
                <div className={cx('right__container')}>
                    <button className={cx('btn_upload')}>
                        <svg
                            className={cx('btn_upload--icon')}
                            width="1em"
                            data-e2e=""
                            height="1em"
                            viewBox="0 0 16 16"
                        ...
                        <p className={cx('btn_upload--text')}>Upload</p>
                    </button>
                </div>
            </div>
        </div>
